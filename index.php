...
<?php 
$query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='US' ORDER BY id desc LIMIT 3"; 
$result = mysqli_query($dbc, $query); 
$i=0; 
echo '<h1 class="naslovSportskeVijesti">U.S.</h1>';
echo '<div class="row">';
...
$result = mysqli_query($dbc, $query); 
$i=0; 
echo '<h1 class="naslovSportskeVijesti">World</h1>';
echo '<div class="row">';
while($row = mysqli_fetch_array($result)) { 
   echo'<a href="clanak.php?id='.$row['id'].'">
<div class="col-md-12">
